		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hello World!",
									"targetURL": "#hraxianshelloworld-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hraxianshelloworld-display": {
								"semanticObject": "hraxianshelloworld",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hr.axians.helloworld",
									"url": sap.ui.require.toUrl("hr/axians/helloworld")
								}
							}
						}
					}
