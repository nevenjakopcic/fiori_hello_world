		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hello World",
									"targetURL": "#hraxianshelloworldhelloworld-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hraxianshelloworldhelloworld-display": {
								"semanticObject": "hraxianshelloworldhelloworld",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hr.axians.helloworld.helloworld",
									"url": sap.ui.require.toUrl("hr/axians/helloworld/helloworld")
								}
							}
						}
					}
